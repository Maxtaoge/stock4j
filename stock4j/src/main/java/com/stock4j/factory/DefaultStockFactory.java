...
public class DefaultStockFactory extends HttpClientPool implements StockFactory {
     ...
     * sina行情服务器
     */
    private final StockFactory sina = new SinaFactory();
    /**
     * 凤凰行情服务器
     */
    private final StockFactory ifeng = new IfengFactory();
    /**
     * QQ行情服务器
     */
    private final StockFactory qq = new QQFactory();
    /**
     * 金融街行情服务器
     */
    private final StockFactory jrj = new JrjFactory();
    /**
     * 163行情服务器
     */
    private final StockFactory wangyi = new WangyiFactory();
    /**
     * 和讯行情服务器
     */
    private final StockFactory hexun = new HexunFactory();
    /**
     * 和讯行情服务器
     */
    private final StockFactory ths = new ThsFactory();
