...
class TickData extends HttpClientPool {
    ...
    /**
     * Tick数据，时间倒序 最大数量 type : 1、  5分钟  2、 15分钟  3、 30分钟  4、 60分钟  5、日线 http://webstock.quote.hermes.hexun.com/a/kline?code=szse000001&start=20161027150000&number=-1000&type=5&callback=callback
     *
