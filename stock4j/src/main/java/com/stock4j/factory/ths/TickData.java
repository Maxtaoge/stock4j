...
class TickData extends HttpClientPool {
    ...
    /**
     * 获取股票的日线数据 https://d.10jqka.com.cn/v2/line/sz_002028/00/last365.js 年线 https://d.10jqka.com.cn/v2/line/sz_002028/00/last31.js
     *
     * @param stock
     * @param size  数量
     * @param rhb   复权方式
     ...
     */
	List<Tick> listDayTicks(Stock stock, int size, ExRightType rhb)
