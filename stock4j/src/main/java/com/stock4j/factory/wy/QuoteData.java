...
class QuoteData extends HttpClientPool {
    ...
    private static final DateTimeFormatter dateTimeQuoteFormatter = DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm:ss");
    private final ObjectMapper mapper = new ObjectMapper();

    /**
     * 同时获取多支股票的盘口报价 http://api.money.126.net/data/feed/0600510
     *
     * @param stock
     ...
     * 获取某支股票的盘口报价
     */
    protected Quote getQuote(Stock stock) throws ErrorHttpException, NullValueException, UnSupportedException {
