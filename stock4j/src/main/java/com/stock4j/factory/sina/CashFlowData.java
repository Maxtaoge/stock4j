...
class CashFlowData extends HttpClientPool {
    ...
    /**
     * 获取资金流数据 http://vip.stock.finance.sina.com.cn/quotes_service/api/json_v2.php/MoneyFlow.ssl_qsfx_lscjfb?page=1&num=20&sort=opendate&asc=0&daima=sh600517
     */
    protected List<CashFlow> listCashFlows(Stock stock, int size)
    ...
    /**
     * 获取即时资金流 http://vip.stock.finance.sina.com.cn/quotes_service/api/jsonp.php/moneyFlowData=/MoneyFlow.ssi_ssfx_flzjtj?daima=sh600517
     *
     * @param stock
     * @return
    ...
    protected CashFlow getCashFlow(Stock stock) throws UnSupportedException, ErrorHttpException, NullValueException {
        String scode = stock.getMarket().name().toLowerCase() + stock.getScode();
        String url =
            "http://vip.stock.finance.sina.com.cn/quotes_service/api/jsonp.php/moneyFlowData=/MoneyFlow.ssi_ssfx_flzjtj?daima="
                + scode;
