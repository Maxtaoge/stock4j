...
class TranscationData extends HttpClientPool {
    ...
    /**
     * 获取某日的大单数据，可设置成交量和成交额门槛 http://vip.stock.finance.sina.com.cn/quotes_service/view/cn_bill_download.php?symbol=sh600517&num=60&page=1&sort=ticktime&asc=0&volume=40000&amount=0&type=0&day=2017-07-07
     *
     * @param stock  股票
