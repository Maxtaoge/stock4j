...
class TickData extends HttpClientPool {
     ...
     */
	List<Tick> listStockTicks(Stock stock, PeriodType period, int size, ExRightType rhb)
        ...
        String url =
            "http://money.finance.sina.com.cn/quotes_service/api/jsonp_v2.php/" + sname + "/CN_MarketData.getKLineData";
